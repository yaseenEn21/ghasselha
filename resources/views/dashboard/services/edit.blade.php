                                ...
                                <div class="row g-6">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <textarea name="description[ar]"
                                                  class="form-control"
                                                  rows="3"
                                                  placeholder="وصف مختصر للخدمة"></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                ...
                                <div class="row g-6">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <input type="number"
                                               ...
                                               name="price"
                                               class="form-control"
                                               placeholder="{{ __('services.price_placeholder') }}" />
                                        <div class="invalid-feedback"></div>
                                    </div>
                                ...
                                <div class="fv-row mb-4">
                                    <div class="image-input image-input-outline w-150px h-150px"
                                        ...
                                        <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                              ...
                                              title="@lang('messages.cancel', [], app()->getLocale())">
